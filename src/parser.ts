import {JsPlumbToolkit, uuid} from "@visuallyjs/browser-ui"
...
export function GanttParser(data:SerializedGantt, toolkit:JsPlumbToolkit, parameters:GanttParserParameters) {
